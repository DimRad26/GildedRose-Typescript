...
describe('Gilded Rose Matser Golden Test', function () {
    ...
    it('Test Bunch - Full Inn', function() {
        ...
        // Sulfuras Tests
        gildedRose.items.push(new Item("Sulfuras, Hand of Ragnaros", 5, 40));
        gildedRose.items.push(new Item("Sulfuras, Hand of Ragnaros", 15, 200));
        gildedRose.items.push(new Item("Sulfuras, Hand of Ragnaros", -1, 15));
        // Backstage Passes Tests
        gildedRose.items.push(new Item("Backstage passes to a TAFKAL80ETC concert", 20, 10));
        gildedRose.items.push(new Item("Backstage passes to a TAFKAL80ETC concert", 15, 10));
        gildedRose.items.push(new Item("Backstage passes to a TAFKAL80ETC concert", 10, 10));
        gildedRose.items.push(new Item("Backstage passes to a TAFKAL80ETC concert", 5, 10));
        // Conjured Tests
        /*
